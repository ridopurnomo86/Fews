<template>
  <ol class="items-center py-10 w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0">
    <li class="flex items-center text-blue-600 dark:text-blue-500 space-x-2.5 cursor-pointer">
      <span
      ...
      <span>
        <h3 class="font-medium leading-tight">Order info</h3>
        <p class="text-sm">Step details here</p>
      </span>
    </li>
    <li class="flex items-center text-gray-500 dark:text-gray-400 space-x-2.5 cursor-pointer">
      <span
